...
| comparison | Spearman ρ | within ±1 | exact | mean diff | Pearson r |
|---|---:|---:|---:|---:|---:|
...
## Per-family presence agreement, rule_qs vs human (Cohen κ, n = 1200)

| family | Cohen κ | rule-positive | human-positive |
|---|---:|---:|---:|
...
| comparison | Spearman ρ | within ±1 | mean diff |
|---|---:|---:|---:|
